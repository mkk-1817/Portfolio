      ...
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={550}>
          <div className="experience">
             <h3>Experience:</h3>
             <h4>Full-Stack Developer & Data Scientist Intern</h4>
            <p>Prediscan MedTech(Remote)| Dec 2024 - Present</p>
            <p>Chennai, India</p><br/>
            <h4>Product Engineer Intern</h4>
            <p>Smartail Pvt Ltd| Jul 2024 - Dec 2024</p>
            <p>Chennai, India</p>
          </div>
        </ScrollAnimation>
